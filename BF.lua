...
_G["HOHO HUB KAITUN RE EDIT BY IXROEVICH"] = {
    ...
    ListFruitTake = {
        'Dough-Dough',"Venom-Venom","Spirit-Spirit",'Leopard-Leopard','Dragon-Dragon',"Mammoth-Mammoth","Kitsune-Kitsune","T-Rex-T-Rex",
    },
...
_G["Use Webhook"] = {
    Enable = true,
    Webhook = "https://discord.com/api/webhooks/1196824710906916934/yt7XGTPqYpmIswNvq2cF-VcPLvxVA00VA6S7Cdb4zZFkU9gjUWmzzv7k6zMaZoJjZcZt",
}
